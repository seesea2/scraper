...
let GiftsHomeComponent = class GiftsHomeComponent {
    constructor() { }
    ngOnInit() { }
};
...
const giftsHomeRoutes = [{ path: '', component: _gifts_home_component__WEBPACK_IMPORTED_MODULE_4__["GiftsHomeComponent"] }];
let GiftsHomeModule = class GiftsHomeModule {
};
...
let HomeCategoriesComponent = class HomeCategoriesComponent {
    constructor(productsApi, router) {
    ...
    ngOnInit() {
        ...
        this.productsApi.getCategoriesWithSamples().subscribe(samples => {
            this.samplesOfCategories = samples;
            this.loading = false;
        }, err => { });
    }
    getCategoryName(categoryWithSamples) {
...
//# sourceMappingURL=gifts-home-gifts-home-module-es2015.js.map