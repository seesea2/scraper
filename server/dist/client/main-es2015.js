...
const routes = [
    ...
    {
        path: 'gifts',
        loadChildren: () => __webpack_require__.e(/*! import() | gifts-gifts-module */ "gifts-gifts-module").then(__webpack_require__.bind(null, /*! ./gifts/gifts.module */ "./src/app/gifts/gifts.module.ts")).then(m => m.GiftsModule)
    },
    {
        path: 'dict',
        loadChildren: () => __webpack_require__.e(/*! import() | dictionary-dictionary-module */ "dictionary-dictionary-module").then(__webpack_require__.bind(null, /*! ./dictionary/dictionary.module */ "./src/app/dictionary/dictionary.module.ts")).then(m => m.DictionaryModule)
    },
    {
        path: 'http',
        loadChildren: () => __webpack_require__.e(/*! import() | send-http-send-http-module */ "send-http-send-http-module").then(__webpack_require__.bind(null, /*! ./send-http/send-http.module */ "./src/app/send-http/send-http.module.ts")).then(m => m.SendHttpModule)
    },
    {
        path: 'lunch',
        loadChildren: () => __webpack_require__.e(/*! import() | lunchfun-lunchfun-module */ "lunchfun-lunchfun-module").then(__webpack_require__.bind(null, /*! ./lunchfun/lunchfun.module */ "./src/app/lunchfun/lunchfun.module.ts")).then(m => m.LunchfunModule)
    },
    {
        path: 'busArrival',
        loadChildren: () => __webpack_require__.e(/*! import() | bus-arrival-bus-arrival-module */ "bus-arrival-bus-arrival-module").then(__webpack_require__.bind(null, /*! ./bus-arrival/bus-arrival.module */ "./src/app/bus-arrival/bus-arrival.module.ts")).then(m => m.BusArrivalModule)
    },
    {
        path: 'staffs',
        loadChildren: () => Promise.all(/*! import() | staffs-staffs-module */[__webpack_require__.e("default~register-login-register-login-module~staffs-staffs-module"), __webpack_require__.e("staffs-staffs-module")]).then(__webpack_require__.bind(null, /*! ./staffs/staffs.module */ "./src/app/staffs/staffs.module.ts")).then(m => m.StaffsModule)
    },
    {
        path: 'webdev',
        loadChildren: () => __webpack_require__.e(/*! import() | web-dev-web-dev-module */ "web-dev-web-dev-module").then(__webpack_require__.bind(null, /*! ./web-dev/web-dev.module */ "./src/app/web-dev/web-dev.module.ts")).then(m => m.WebDevModule)
    }
];
