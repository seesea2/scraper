...
/***/ "./src/app/gifts-browse/browse.component.html":
/*!****************************************************!*\
  !*** ./src/app/gifts-browse/browse.component.html ***!
  \****************************************************/
/*! no static exports found */
...
var BrowseComponent = /** @class */ (function () {
    function BrowseComponent(productsApiService, cartApiService, activatedRoute, router) {
    ...
    BrowseComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (p) {
            _this.refresh(p.category);
        });
    };
    BrowseComponent.prototype.getProducts = function (category) {
        var _this = this;
        this.productsApiService.getProducts(category).subscribe(function (data) {
            _this.products = data;
            _this.productCurrentQty = [];
            data.forEach(function (d) {
                _this.productCurrentQty.push(1);
            });
        }, function (err) {
            console.log(err.error);
        });
    };
    BrowseComponent.prototype.refresh = function (category) {
    ...
    BrowseComponent.prototype.onBreadcrumb = function (ind) {
        var newCategory = '';
        for (var i = 0; i <= ind; ++i) {
...
//# sourceMappingURL=gifts-browse-gifts-browse-module.js.map