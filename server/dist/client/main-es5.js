...
var routes = [
    ...
    },
    {
        path: 'http',
        loadChildren: function () {
            return __webpack_require__.e(/*! import() | send-http-send-http-module */ "send-http-send-http-module").then(__webpack_require__.bind(null, /*! ./send-http/send-http.module */ "./src/app/send-http/send-http.module.ts")).then(function (m) { return m.SendHttpModule; });
        }
    },
    {
        path: 'lunch',
    ...
    },
    {
        path: 'busArrival',
        loadChildren: function () {
            return __webpack_require__.e(/*! import() | bus-arrival-bus-arrival-module */ "bus-arrival-bus-arrival-module").then(__webpack_require__.bind(null, /*! ./bus-arrival/bus-arrival.module */ "./src/app/bus-arrival/bus-arrival.module.ts")).then(function (m) { return m.BusArrivalModule; });
        }
    },
    {
        path: 'staffs',
