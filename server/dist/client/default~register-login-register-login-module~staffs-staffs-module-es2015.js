...
let LoginComponent = class LoginComponent {
    ...
    login(uid, pwd) {
        this.usersService.login(this.bStaffLogin, uid, pwd).subscribe(data => {
            this.errMsg = '';
...
let RegisterLoginRoutingModule = class RegisterLoginRoutingModule {
};
...
let RegisterLoginModule = class RegisterLoginModule {
};
...
let RegisterComponent = class RegisterComponent {
    ...
    onSubmit() {
        ...
        this.loading = true;
        this.errMsg = '';
        this.usersService.register(this.registerForm).subscribe(data => {
...
//# sourceMappingURL=default~register-login-register-login-module~staffs-staffs-module-es2015.js.map